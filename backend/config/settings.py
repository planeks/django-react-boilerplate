...
# CELERYBEAT_SCHEDULE_FILENAME = config('CELERYBEAT_SCHEDULE_FILENAME', default='/data/celerybeat-schedule.db')
CELERY_BEAT_SCHEDULE = {}

DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@project.com')
